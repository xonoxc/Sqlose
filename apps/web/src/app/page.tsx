    ...
    <div className="min-h-screen bg-[#050505] text-zinc-300 font-sans selection:bg-emerald-500/30 overflow-x-hidden">
      ...
      <nav className="relative border-b border-white/10 bg-[#050505]/80 backdrop-blur-md z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between h-16 px-6 relative">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-mono text-zinc-500">
            ...
            <a href="#stack" className="hover:text-purple-400 transition-colors">.stack()</a>
      ...
      <section className="relative max-w-7xl mx-auto px-6 pt-24 pb-32 flex flex-col lg:flex-row items-center gap-16">
        <div className="flex-1 relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-white mb-6 leading-[1.1]">
            The <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-blue-500">ephemeral</span> stack{' '}
            <br />
            for data artisans.
          </h1>
          ...
          <p className="text-xl text-zinc-400 mb-10 max-w-xl font-light leading-relaxed">
            ...
            flow = <span className="text-amber-300 font-mono text-sm">['spin up', 'query', 'throw away']</span>;
            <br className="mb-2"/>
            SQLose gives you fully isolated DB environments with zero configuration and zero leftover clutter.
          </p>
        ...
        <div className="flex-1 w-full h-[500px] flex items-center justify-center relative perspective-[1000px]">
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 w-px h-[60px] bg-white/20 border-l border-dashed border-purple-500/50" style={{ transform: 'rotateX(-90deg) translateZ(30px) translateY(-30px)' }} />
            ...
            <div className="absolute top-1/2 left-1/4 w-px h-[60px] bg-white/20 border-l border-dashed border-amber-500/50" style={{ transform: 'rotateX(-90deg) translateZ(-30px) translateY(-30px)' }} />
            <div className="absolute top-1/2 right-1/4 w-px h-[60px] bg-white/20 border-l border-dashed border-amber-500/50" style={{ transform: 'rotateX(-90deg) translateZ(-30px) translateY(-30px)' }} />
      ...
      <section className="relative max-w-6xl mx-auto px-6 py-24 z-10">
        <div className="mb-12">
           ...
           <p className="font-mono text-sm text-zinc-500">class UI extends App {'{'} ... {'}'}</p>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/10">
          <div className="p-10 md:p-16 relative group hover:bg-white/[0.01] transition-colors">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-6">
              Launch isolated environments instantly. Close the app, and the containers vanish.
            </p>
          ...
          <div className="p-10 md:p-16 relative group hover:bg-white/[0.01] transition-colors">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-6">
              Full syntax highlighting, autocomplete, and optional Vim bindings integrated out-of-the-box.
            </p>
          ...
          <div className="p-10 md:p-16 relative group hover:bg-white/[0.01] transition-colors">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-6">
              ...
              <span className="text-purple-400 font-mono">flex-1 min-w-0</span> for fluid scaling.
            </p>
      ...
      <footer className="border-t border-white/10 bg-[#020202] relative">
         <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-12 font-mono text-sm">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <a href="#" className="inline-flex items-center text-emerald-400 hover:text-emerald-300 transition-colors">
                Initialize <ChevronRight className="w-4 h-4 ml-1" />
              </a>
            </div>

            <div>
              <h4 className="text-zinc-300 mb-4 border-b border-white/10 pb-2 inline-block">Modules</h4>
              <ul className="space-y-3 text-zinc-500">
                <li><a href="#" className="hover:text-blue-400 transition-colors">Desktop App</a></li>
                <li><a href="#" className="hover:text-blue-400 transition-colors">Core Engine</a></li>
                <li><a href="#" className="hover:text-blue-400 transition-colors">Docker Drivers</a></li>
              </ul>
            </div>

            <div>
              <h4 className="text-zinc-300 mb-4 border-b border-white/10 pb-2 inline-block">System</h4>
              <ul className="space-y-3 text-zinc-500">
                <li><a href="#" className="hover:text-amber-400 transition-colors">GitHub Repository</a></li>
                <li><a href="#" className="hover:text-amber-400 transition-colors">Documentation</a></li>
                <li><a href="#" className="hover:text-amber-400 transition-colors">Releases</a></li>
              </ul>
            </div>
         </div>
