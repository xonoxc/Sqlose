...
export function Sidebar({
   ...
   return (
      <div className={cn("flex h-full flex-col bg-[#111111] text-[#909090] w-full", className)}>
         {header && <div className="px-5 py-[14px] min-h-[56px] flex items-center shrink-0 app-drag-region">{header}</div>}
         
         <div className="flex items-center justify-between px-5 py-2 app-no-drag mt-2">
            <div className="flex items-center gap-2">
               <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="opacity-80"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
