         ...
         <div className="flex-1 max-w-md mx-4">
            ...
            >
               ...
               <div className="ml-auto flex items-center gap-1 opacity-50">
                  {isMac() ? (
                     <>
                        <kbd className="bg-bg-primary text-[11.5px] font-mono px-1.5 py-[2px] rounded border border-border/60 shadow-sm leading-none shrink-0">⌘</kbd>
                        <kbd className="bg-bg-primary text-[11.5px] font-mono px-1.5 py-[2px] rounded border border-border/60 shadow-sm leading-none shrink-0">K</kbd>
                     </>
                  ) : (
                     <kbd className="bg-bg-primary text-[11.5px] font-mono px-1.5 py-[2px] rounded border border-border/60 shadow-sm leading-none shrink-0">Ctrl+K</kbd>
                  )}
               </div>
            </button>
         </div>
