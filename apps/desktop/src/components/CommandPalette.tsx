            ...
            >
               ...
               >
                  ...
                  <div className="flex items-center gap-3 px-5 py-3.5 border-b border-border/50">
                      {mode === "themes" || mode === "databases" ? (
                         <button
                            onClick={mode === "themes" ? exitThemeMode : exitDatabaseMode}
                            ...
                            {filteredEnvironments.slice(0, 10).map((env, index) => {
                               ...
                               return (
                                  ...
                                  >
                                     ...
                                     <div className="flex-1 flex items-center justify-between min-w-0 font-medium">
                                        <span className="text-[14.5px] truncate">{env.name || `${env.dbType} environment`}</span>
                                        <span
                                           className={cn(
                                              "text-[11px] ml-2",
                                              isActive ? "text-white/70" : "text-text-muted/60"
                                    ...
                                    {visibleInGroup.map(item => {
                                       ...
                                       return (
                                          <button
                                             ...
                                             onClick={() => {
                                                item.onSelect()
                                                 if (item.id !== "switch-theme" && item.id !== "switch-db") onClose()
                                             }}
